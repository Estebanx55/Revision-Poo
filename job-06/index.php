...
$sql = "SELECT * FROM category WHERE id_category = 3";
...
$category2 = new Category($pdo, $resultat['id_category'], $resultat['name'], $resultat['description'], $resultat['created_date'], $resultat['update_date']);

echo $category2->getProduct() . '<br/>';